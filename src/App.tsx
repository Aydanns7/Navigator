...
function App() {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: "#F19CBB", flex:1}}>
            <View style={{ flexDirection: "row", marginTop: 40 }}>

                <TextInput
                    placeholder='Write a movie name,please...'
                    style={{width: 300, height: 50, borderRadius: 10, borderWidth: 2, backgroundColor: '#FEFEFA', marginLeft: 30, fontSize: 18 }}
                    value={searchMovie}
                ...
                <View style={{ flexDirection: 'column' }}>
                    <TouchableOpacity
                        ...
                        style={{ width: 50, height: 50, backgroundColor: '#8e4585', borderRadius: 10, borderWidth: 2, justifyContent: 'center', alignItems: 'center' }}>
                        <Image style={{ width: 30, height: 30, alignItems: 'center', justifyContent: 'center' }} source={require('./assets/icons/Search.png')} />
                    </TouchableOpacity>
    </View>
